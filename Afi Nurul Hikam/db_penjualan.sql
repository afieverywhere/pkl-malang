...
--
ALTER TABLE `tb_master_barang`
  ADD CONSTRAINT `fk_id_akun1` FOREIGN KEY (`id_akun`) REFERENCES `tb_akun` (`id_akun`),
  ADD CONSTRAINT `fk_id_barang` FOREIGN KEY (`id_barang`) REFERENCES `tb_stok` (`id_barang`);
COMMIT;
